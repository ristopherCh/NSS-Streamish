...
VALUES
    (1, 'Groucho', 'groucho@marx.com', SYSDATETIME(), NULL, 'fakeId1'),
    (2, 'Harpo', 'harpo@marx.com', SYSDATETIME(), NULL, 'fakeId2'),
    (3, 'Chico', 'chico@marx.com', SYSDATETIME(), NULL, 'fakeId3'),
    (4, 'Chris Hanson', 'chanson8@gmail.com', SYSDATETIME(), 'https://avatars.githubusercontent.com/u/65626884?v=4', '5CjnqtXC6Eef9krDkCnjvpNpsIR2'),
    (5, 'Real Person', 'test@test.com', SYSDATETIME(), 'https://www.teachtoday.de/mediabase/img/4339.jpg', 'wvxtbFslIMhbx5taRQxHopwjQVo2')
